...
<body data-spy="scroll" data-target=".subnav" data-offset="50" class="<?=(strtolower(Request::current()->controller())!=='faq' AND Theme::get('fixed_toolbar')==1)?'':'body_fixed'?>">
    <div class="container wrapper">
        ...
        <div class="row content">
            ...
            <?else:?>
                <div class="content-right <?=(Theme::get('sidebar_position')!='none')?'col-lg-9 col-md-9 col-sm-12 col-xs-12':'col-lg-12'?> <?=(Theme::get('sidebar_position')=='left')?'pull-right':'pull-left'?>">
                    <?=(Theme::get('breadcrumb')==1 AND Theme::landing_single_ad() == FALSE)?Breadcrumbs::render('breadcrumbs'):''?>
                    <?=Alert::show()?>
                ...
                <?=(Theme::get('sidebar_position')=='left' AND Theme::landing_single_ad() == FALSE)?View::fragment('sidebar_front','sidebar'):''?>
                <?=(Theme::get('sidebar_position')=='right' AND Theme::landing_single_ad() == FALSE)?View::fragment('sidebar_front','sidebar'):''?>
            <?endif?>
