...
<div class="page-header">
    ...
    <?if (Theme::get('publish_new_html') != '') :?>
        <?=Theme::get('publish_new_html')?>
    <?endif?>
</div>
<div class="row">
            ...
            <?= FORM::open(Route::url('post_new',array('controller'=>'new','action'=>'index')), array('class'=>'form-horizontal post_new', 'id'=>'publish-new', 'enctype'=>'multipart/form-data'))?>
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=_e('Description')?></h3>
                    </div>
                ...
                <?if(core::config("advertisement.num_images") > 0 ):?>
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?=_e('Images')?></h3>
                        </div>
                        <div class="panel-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=_e('Info')?></h3>
                    </div>
                    <div class="panel-body">
                ...
                <div id="custom-fields-wrapper" class="panel panel-info hidden">
                    <div class="panel-heading">
