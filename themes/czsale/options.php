...
return array(   'premium' => array( 'type'      => 'numeric',
                ...
                'logo_url' => array(   'type'      => 'text',
                                            'display'   => 'logo',
                                            'label'     => __('Upload your Logo. Recommended size W:200px x H:120px and file format PNG. Leave blank for none.'),
                                            'default'   => '',
                                            'category'  => __('General')),
                ...
                'homepage_html' => array(   'type'      => 'text',
                                            ...
                                            'default'   => '',
                                            'category'  => __('Homepage')),
                'publish_new_html' => array(   'type'      => 'text',
                                            'display'   => 'textarea',
                                            'label'     => __('Publish new message, allows HTML'),
                                            'default'   => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sit amet porta eros, eget facilisis arcu. Duis condimentum fermentum enim, ac rutrum erat venenatis vel. Morbi pharetra viverra faucibus.',
                                            'category'  => __('General')),
                'rtl' => array(             'type'      => 'text',
                                            'display'   => 'select',
