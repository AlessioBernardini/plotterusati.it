                                    ...
                                    <div class="thumbnail latest_ads">
                                        <a href="<?=Route::url('ad', array('category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>" class="min-h">
                                            <?if($ad->get_first_image()!== NULL):?>
                                                <?=HTML::picture($ad->get_first_image('image'), ['w' => 200, 'h' => 200], ['1200px' => ['w' => '170', 'h' => '170'],'992px' => ['w' => '132', 'h' => '132'], '768px' => ['w' => '138', 'h' => '138']], ['alt' => HTML::chars($ad->title)])?>
                                            <?elseif( ($icon_src = $ad->category->get_icon()) !== FALSE):?>
                                                <?=HTML::picture($icon_src, ['w' => 200, 'h' => 200], ['1200px' => ['w' => '170', 'h' => '170'],'992px' => ['w' => '132', 'h' => '132'], '768px' => ['w' => '138', 'h' => '138']], ['alt' => HTML::chars($ad->title)])?>
                                            <?else:?>
...
<section class="well categories">
    ...
    <div class="row">
        <?$i=0; foreach($categs as $c):?>
            ...
            <? $i++; if ($i%3 == 0) echo '<div class="clear"></div>'; endif?>
        <?endforeach?>
