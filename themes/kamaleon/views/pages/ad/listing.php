                    ...
                    <div class="thumbnail max-h">
                        <a href="<?=Route::url('ad', array('category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>">
                      		<?if($ad->get_first_image()!== NULL):?>
                                <?=HTML::picture($ad->get_first_image(), ['w' => 171, 'h' => 171], ['1200px' => ['w' => '172', 'h' => '172'],'992px' => ['w' => '135', 'h' => '135'], '768px' => ['w' => '140', 'h' => '140']], array('class' => 'center-block', 'alt' => HTML::chars($ad->title)))?>
                            <?elseif( ($icon_src = $ad->category->get_icon()) !== FALSE):?>
                                <?=HTML::picture($icon_src, ['w' => 171, 'h' => 171], ['1200px' => ['w' => '172', 'h' => '172'],'992px' => ['w' => '135', 'h' => '135'], '768px' => ['w' => '140', 'h' => '140']], array('class' => 'center-block', 'alt' => HTML::chars($ad->title)))?>
                            <?else:?>
                                <img data-src="holder.js/171x171?<?=str_replace('+', ' ', http_build_query(array('text' => $ad->category->translate_name(), 'size' => 14, 'auto' => 'yes')))?>" alt="<?=HTML::chars($ad->title)?>">
                            <?endif?>
                        </a>
                      	<div class="caption">
...
<section class="post-section clearfix" id="post-details">
    ...
    <div class="well recomentadion clearfix blog-description" id="recomentadion">
	    ...
	    <i class="glyphicon glyphicon-pencil"></i> <a title="<?=__('New Advertisement')?>"
	            href="<?=Route::url('post_new')?>?category=<?=($category!==NULL)?$category->seoname:''?>&amp;location=<?=($location!==NULL)?$location->seoname:''?>"><?=_e('Publish new advertisement')?></a>
        <?endif?>
                    ...
                    <div class="thumbnail <?=($ad->featured >= Date::unix2mysql(time()))?'featured-item':''?>">
                        <? if($ad->featured >= Date::unix2mysql(time())):?>
                            <div class="ribbon-wrapper-green">
                                <div class="ribbon-green">&nbsp;<span><?= _e('Featured'); ?></span></div>
                            </div>
                        <?endif?>
                        ...
                        <div class="picture">
                            <a class="pull-left" title="<?=HTML::chars($ad->title)?>" href="<?=Route::url('ad', array('controller'=>'ad','category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>">
                                <figure>
                                    ...
                                    <?elseif(( $icon_src = $ad->category->get_icon() )!==FALSE ):?>
                                        <img src="<?=Core::imagefly($icon_src,130,130)?>" class="img-responsive" alt="<?=HTML::chars($ad->title)?>" />
                                    <?else:?>
                                        <img data-src="holder.js/130x130?<?=str_replace('+', ' ', http_build_query(array('text' => $ad->category->translate_name(), 'size' => 14, 'auto' => 'yes')))?>" class="img-responsive" alt="<?=HTML::chars($ad->title)?>">
                                    <?endif?>
                                </figure>
                            </a>
                        </div>
