...
return array(   'premium' => array( 'type'      => 'numeric',
                ...
                'fixed_header' => array(  'type'      => 'text',
                                            'display'   => 'select',
                                            'label'     => __('Fix header to top'),
                                            'options'   => array(   '1' => __('Yes'),
                                                                    '0'  => __('No'),
                                                                ),
                                            'default'   => '0',
                ...
                'breadcrumb' => array(   'type'      => 'text',
                                            'display'   => 'select',
                                            'label'     => __('Display breadcrumb. Note: breadcrumbs are hidden when fixed header is enabled.'),
                                            'options'   => array(   '1' => __('Yes'),
                                                                    '0'  => __('No'),
                                                                ),
                                            'default'   => '1',
                ...
                'upper_banner' => array(  'type'      => 'text',
                                            'display'   => 'select',
                                            'label'     => __('Show main banner on homepage'),
                                            'options'   => array(   '1' => __('Yes'),
                                                                    '0'  => __('No'),
                                                                ),
                                            'default'   => '1',
                ...
                'upper_banner_image' => array(   'type'      => 'text',
                                            'display'   => 'logo',
                                            'label'     => __('If homepage upper banner is active, the url of the image'),
                                            'default'   => '',
                                            'category'  => __('Homepage')),
                ...
                'lower_banner' => array(  'type'      => 'text',
                                            'display'   => 'select',
                                            'label'     => __('Show lower text banner on homepage'),
                                            'options'   => array(   '1' => __('Yes'),
                                                                    '0'  => __('No'),
                                                                ),
                                            'default'   => '1',
                ...
                'num_home_latest_ads' => array(  'type'      => 'text',
                                            'display'   => 'text',
                                            'label'     => __('Num latest ads in home'),
                                            'default'   => '12',
                                            'required'  => TRUE,
                                            'category'  => __('Homepage')),
