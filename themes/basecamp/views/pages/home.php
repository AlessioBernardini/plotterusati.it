			...
			<?if (Core::Config('appearance.map_active')):?>
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1 text-center">
                        <h3 class="text-center"><?=_e("Map")?></h3>
...
<?if (Theme::get('lower_banner') == 1) : ?>
<!-- MAIN CONTENT - GET STARTED -->
	<div class="post-ad-banner color-section hidden-xs">
		<div class="container">
			<div class="row">
				<div class="col-sm-9">
				...
				<div class="col-sm-3 text-right post-ad-banner-btn">
					<a class="btn btn-base-light btn-lg" href="<?=Route::url('post_new')?>">
						<?=_e('Publish new ')?>
					</a>
				</div>
