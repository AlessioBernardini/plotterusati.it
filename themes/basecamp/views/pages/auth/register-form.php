	...
	<div class="modal-body">
		...
		<?foreach(Model_UserField::get_all() as $name=>$field):?>
	        <?if($field['show_register'] AND $name!='verifiedbadge' AND $name!='whatsapp'):?>
	            <div class="form-group clearfix">
	                ...
	                <?= FORM::label('cf_'.$name, $field['label'], array('class'=>'col-xs-12 control-label', 'for'=>'cf_'.$name))?>
	                <div class="col-xs-12 col-sm-8">
	        ...
	        <?elseif($name=='whatsapp'):?>
	            <div class="form-group" id="cf_new">
	                <label class="col-xs-12 control-label" for="cf_whatsapp"><?=_e('Whatsapp Number')?></label>
	                <div class="col-sm-8">
	    ...
	    <div class="form-group clearfix">
	        <?if (Core::config('advertisement.captcha')):?>
	            ...
	            <?else:?>
	                <label class="col-xs-12 control-label"><?=_e('Captcha')?>*:</label>
	                <div class="col-xs-12 col-sm-8">
