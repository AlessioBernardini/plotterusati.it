	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="blog-full">
					<p class="post-info">
						<span class="glyphicon glyphicon-user"></span> <?=$post->user->name?>  <?=$post->user->is_verified_user();?> &nbsp&nbsp <span class="glyphicon glyphicon-calendar"></span> <?=Date::format($post->created, core::config('general.date_format'))?>  
					</p>
