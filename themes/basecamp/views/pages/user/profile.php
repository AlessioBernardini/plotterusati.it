						...
						<div class="col-sm-9">
							...
							<p>
								<ul class="list-unstyled">
									<li>
										<strong><?=_e('Created')?>:</strong>
										<?= Date::format($user->created, core::config('general.date_format')) ?>
									</li>
									<?if ($user->last_login!=NULL):?>
										<li>
											<strong><?=_e('Last Login')?>:</strong>
											<?= Date::format($user->last_login, core::config('general.date_format'))?>
										</li>
									<?endif?>
												...
												<?$visitor = Auth::instance()->get_user()?>
																...
																<div class="modal-content">
																	<div class="modal-body">
																		...
																		<ul class="ad_controls_list">
																			<li><a class="btn btn-success" href="<?=Route::url('oc-panel', array('controller'=>'myads','action'=>'update','id'=>$ads->id_ad))?>"><i class="glyphicon glyphicon-edit"></i> <?=_e("Edit");?></a></li>
													...
													<?else:?>
														<span class="ad_price na">
															<a class="add-transition" title="<?=HTML::chars($ads->title)?>" href="<?=Route::url('ad', array('controller'=>'ad','category'=>$ads->category->seoname,'seotitle'=>$ads->seotitle))?>"><?=_e('Check Listing');?></a>
														</span>
													<?endif?>
											</div>
										</div>
