				...
				<div class="topic-view">
					...
					<div class="col-xs-12 topic-author">
						...
						<?if (in_array('profile', Route::all())) :?>
							<li><b><a href="<?=Route::url('profile', array('seoname'=>$topic->user->seoname)) ?>"><?=$topic->user->name?> <?=$topic->user->is_verified_user()?></a></b></li>
						<?else :?>
							<li><b><?=$topic->user->name?> <?=$topic->user->is_verified_user()?></b></li>
						<?endif?>
					...
					<div class="col-xs-12 forum-comment">
						...
						<div class="comment-content">
							...
							<?
								try {
							?>
							<a href="<?=Route::url('profile', array('seoname'=>$reply->user->seoname)) ?>"><?=$reply->user->name?> <?=$reply->user->is_verified_user()?></a>
							<?    
								} catch (Exception $e) {
