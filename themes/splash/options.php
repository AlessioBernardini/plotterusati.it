...
return array(   'premium'               => array(   'type'      => 'numeric',
                ...
                'theme'                  => array(  'type'      => 'text',
                                                    ...
                                                    'options'   => array(   'oc'    => 'OC',
                                                                            'orange-blue'     => 'Obi Wan',
                                                                            'brown-blue'	=> 'Chewbacca',
                                                                            'yellow-green' => 'Han Solo',
                                                                            'red-green'	=> 'Luke Skywalker',
                                                                            'pink-green'	=> 'Leia',
                                                                            'orange-blueish'	=> 'Lando Calrissian',
                                                                        ),
                                                    'default'   => 'oc',
                                                    'required'  => TRUE,
                                                    'category'  => __('Color')
                ...
                'num_home_latest_ads'   => array(   'type'      => 'text',
                                                    'display'   => 'text',
                                                    'label'     => __('Numbers of ads to display on homepage. Recommended 5.'),
                                                    'default'   => 5,
                                                    'required'  => TRUE,
                ...
                'home_bg_image'         => array(   'type'      => 'text',
                                                    'display'   => 'logo',
                                                    'label'     => __('Homepage background image URL'),
                                                    'default'   => '',
                                                    'category'  => __('Homepage')
                                                ),
                'home_bg_image_overlay' => array(   'type'      => 'text',
                                                    'display'   => 'select',
                                                    'label'     => __('Overlay on Homepage background image'),
                                                    'options'   => array(   '1' => __('Yes'),
                                                                            '0'  => __('No'),
                                                                        ),
                                                    'category'  => __('Homepage')
