...
<section id="page-header">
    <div class="container no-gutter">
        <div class="row">
            <div class="col-sm-8">
                <h1 class="h1"><?=_e('Edit Profile')?></h1>
            </div>
                                    ...
                                    <?= FORM::open(Route::url('oc-panel',array('controller'=>'profile','action'=>'edit')), array('class'=>'form-horizontal', 'enctype'=>'multipart/form-data'))?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <?else:?>
                                                    <?= FORM::input('phone', $user->phone, array('class'=>'form-control', 'id'=>'phone', 'type'=>'phone' ,'placeholder'=>__('Phone'), 'data-country' => core::config('general.country')))?>
                                                <?endif?>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <?if ($user->google_authenticator!=''):?>
                                        ...
                                        <p>
                                        <?=_e('Google Authenticator Code')?>: <?=$user->google_authenticator?>
                                        </p>
