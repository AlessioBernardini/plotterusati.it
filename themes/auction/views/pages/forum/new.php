...
<div class="">
	...
	<fieldset>
		...
		<div class="form-group control-group">
			<?= FORM::label('title', __('Title'), array('class'=>'col-sm-2 control-label', 'for'=>'title'))?>
			<div class="col-sm-10 controls">
				<?= FORM::input('title', HTML::chars(core::post('title')), array('placeholder' => __('Title'), 'class' => 'form-control input-xlarge', 'id' => 'title', 'required'))?>
			</div>
		</div>
		<div class="form-group control-group">
			<?= FORM::label('description', __('Description'), array('class'=>'col-sm-2 control-label', 'for'=>'description'))?>
			<div class="col-sm-10 controls">
				<?= FORM::textarea('description', HTML::chars(core::post('description')), array('placeholder' => __('Description'), 'class' => 'form-control input-xxlarge', 'name'=>'description', 'id'=>'description', 'required'))?>
			</div>
		</div>
