...
<form class="form-horizontal register"  method="post" action="<?=Route::url('oc-panel',array('directory'=>'user','controller'=>'auth','action'=>'register'))?>">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label"><?=_e('Name')?></label>
        <div class="col-sm-6">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label"><?=_e('Email')?></label>
        <div class="col-sm-6">
            <input
                class="form-control"
                type="text"
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label"><?=_e('New password')?></label>
        <div class="col-sm-6">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label"><?=_e('Repeat password')?></label>
        <div class="col-sm-6">
    ...
    <?foreach(Model_UserField::get_all() as $name=>$field):?>
        <?if($field['show_register'] AND $name!='verifiedbadge' AND $name!='whatsapp'):?>
            <div class="form-group">
                ...
                <?= FORM::label('cf_'.$name, $field['label'], array('class'=>'col-sm-3 control-label', 'for'=>'cf_'.$name))?>
                <div class="col-sm-6">
        ...
        <?elseif($name=='whatsapp'):?>
            <div class="form-group" id="cf_new">
                <label class="col-xs-3 control-label" for="cf_whatsapp"><?=_e('Whatsapp Number')?></label>
                <div class="col-sm-6">
    ...
    <div class="form-group">
        <?if (Core::config('advertisement.captcha')):?>
            ...
            <?else:?>
                <label class="col-sm-3 control-label"><?=_e('Captcha')?>*:</label>
                <div class="col-sm-6">
...
<?if (Core::config('general.sms_auth') == TRUE ):?>
    ...
    <div class="page-header">
        <h1 class="text-center"><?=_e('Phone Register')?></h1>
    </div>
    <?=View::factory('pages/auth/phoneregister-form-modal')?>
<?endif?>
