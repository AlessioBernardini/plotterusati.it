...
/**
  * Theme Name: Pinclass
  * Description: Pinclass is a grid layout theme. It works by placing elements in optimal position based on available vertical space, sort of like a mason fitting stones in a wall. You’ve probably seen it in use all over the Internet.
  * Tags: Pinclass, HTML5, grid layout
  * Version: 3.7.0
  * Author: Thom <thom@open-classifieds.com>
  * License: Commercial
  * Parent Theme: default
  * Skins: oc, amber, blue, orange, red, teal
  */
/**
...
if (Core::config('appearance.allow_query_theme')=='1')
{
    ...
    elseif (Cookie::get('skin_pinclass')!=='')
    {
        Theme::$skin = Cookie::get('skin_pinclass');
    }
    ...
    Cookie::set('skin_pinclass', Theme::$skin, Core::config('auth.lifetime'));
}
...
if (Theme::get('cdn_files') == FALSE AND ! method_exists('Core','yclas_url'))
{
    ...
    Theme::$scripts['footer']   = array('js/jquery.min.js',
                                        ...
                                        'js/select2.min.js',
                                        'js/holder.min.js',
                                        '//cdn.jsdelivr.net/imagesloaded/4.1.0/imagesloaded.pkgd.min.js',
                                        'js/modernizr.js',
...
else
{
    ...
    Theme::$scripts['footer'] = array('//cdn.jsdelivr.net/g/jquery@1.12.4,masonry@4.0.0,prettyphoto@3.1.5,select2@4.0.3,holder@2.9.3,jquery.validation@1.15.0,modernizr@2.8.3',
