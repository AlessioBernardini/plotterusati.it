<div class="page-header">
    ...
    <div class="col-md-3 span2">
        <div class="thumbnail highlight <?=(Theme::get('dark_listing'))?'dark_listing':''?>">
...
<form class="well form-horizontal <?=(Theme::get('dark_listing'))?'dark_listing':''?>" id="reply_form" method="post" action="<?=Route::url('forum-topic',array('seotitle'=>$topic->seotitle,'forum'=>$forum->seoname))?>"> 
<h3><?=_e('Reply')?></h3>
  <?php if ($errors): ?>
