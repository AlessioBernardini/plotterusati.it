...
<div class="navbar navbar-default <?if(Theme::get('dark_listing')!='0'):?>dark-header<?endif?>">
    <div class="container<?if(Theme::get('boxed_layout')!='1'):?>-fluid<?endif?> header-inner">
        <div class="row">
                ...
                <div class="col-xs-9 col-md-4 hidden-lg hidden-md">
                    <div class="navbar-btn pull-right">
                        <?if ((Core::config('advertisement.only_admin_post')!=1) OR (Core::config('advertisement.only_admin_post')==1 AND Auth::instance()->logged_in() AND (Auth::instance()->get_user()->is_admin() OR Auth::instance()->get_user()->is_moderator()))):?>
                            ...
                            <a class="btn btn-primary pull-right hidden-sm hidden-md hidden-lg" href="<?=Route::url('post_new')?>">
...
<section class="search-container">
    <div class="container<?if(Theme::get('boxed_layout')!='1'):?>-fluid<?endif?>">
        <div class="row">
            <div class="col-lg-12">
                <div class="row no-gutter">
                    ...
                    <?else:?>
                        <?=FORM::open(Route::url('search'), array('class'=>'frm search-frm', 'method'=>'GET', 'action'=>''))?>
                            ...
                            <?else:?>
                            <div class="form-group select-input col-sm-12 col-md-5">
                            <?endif?>
                                <div class="control">
