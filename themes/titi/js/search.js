    ...
    $.each(customfields, function (idx, customfield) {
        ...
        switch (customfield.type) {
            ...
            case 'decimal':
                ...
                break;
            case 'range':
                var rangeFromPlaceholder = getCFSearchLocalization('from');
                var rangeToPlaceholder = getCFSearchLocalization('to');

                if (idx == 'cf_ano')
                {
                    rangeFromPlaceholder = 1960;
                    rangeToPlaceholder = 2017;
                }

                if (idx == 'cf_kilometers')
                {
                    rangeFromPlaceholder = 0;
                    rangeToPlaceholder = 100000;
                }
