...
/**
  * Theme Name: Jobdrop
  * Description: The jobdrop theme is made with the focus on job boards. So if you are interested in starting a job board, then this is the theme for you!
  * Tags: job, jobdrop, job board, open classifieds
  * Version: 3.7.0
  * Author: Thom <thom@open-classifieds.com>
  * License: Commercial
  * Parent Theme: default
  * Skins: oc,red,blue,amber,orange,teal
 ...
 */
$theme_data = json_decode(core::config('theme.jobdrop'), TRUE);
...
if (Core::config('appearance.allow_query_theme')=='1')
{
    ...
    elseif (Cookie::get('skin_jobdrop')!=='')
    {
        Theme::$skin = Cookie::get('skin_jobdrop');
    }
    ...
    Cookie::set('skin_jobdrop', Theme::$skin, Core::config('auth.lifetime'));
}
...
if (Theme::get('cdn_files') == FALSE AND ! method_exists('Core','yclas_url'))
{
    ...
    $common_css =  array('css/fontawesome-all.css' => 'screen',
                        ...
                        '//fonts.googleapis.com/css?family=Montserrat:400,700' => 'screen'
                        );
