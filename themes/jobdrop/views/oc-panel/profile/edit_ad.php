    ...
    <div class="row">
        <div class="col-md-12">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-prepend">
                                        <?= FORM::input('price', i18n::format_currency_without_symbol($ad->price), array('placeholder'=>html_entity_decode(i18n::money_format(1)),'class'=>'form-control', 'id' => 'price','data-decimal_point' => i18n::get_decimal_point()))?>
                                    </div>
                                </div>
                            </div>
                            <?endif?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?= FORM::open(Route::url('oc-panel', array('controller' => 'mylistings', 'action' => 'update', 'id' => $ad->id_ad)), array('class' => 'form-horizontal edit_ad_photos_form', 'enctype' => 'multipart/form-data')) ?>
                    <fieldset>
                        <div class="form-group">
                                                ...
                                                <?if(isset($value['thumb'])): // only formated images (not originals)?>
                                                    <div id="img<?=$key?>" class="col-md-4 col-sm-4 col-md-4 edit-image">
                                                        <a href="<?=$value['image']?>" class="gallery-item" data-gallery>
                                                            <img src="<?=$value['thumb']?>" class="img-rounded thumbnail img-responsive">
                                                        </a>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <?= FORM::button('submit_btn', _e('Upload'), array('id' => 'upload-photos-btn', 'type' => 'submit', 'class' => 'btn btn-primary', 'action' => Route::url('oc-panel', array('controller' => 'mylistings', 'action' => 'update', 'id' => $ad->id_ad)))) ?>
                            </div>
                        </div>
                    </fieldset>
                    <?= FORM::close()?>
