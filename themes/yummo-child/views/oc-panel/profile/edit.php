...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="changepass">
                <div class="row">
                    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="googleauthenticator">
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="profilepictures">
                <div class="row">
                    <div class="col-md-12">
...
<script>
    //se la url contiene "changepass" nascondo le altre form e mostro solo quella per il cambio password
    function getCurrentURL () {
        return window.location.href
    }
    const url = getCurrentURL();
    let = url.search("changepass");
    if(let != -1){
        document.getElementById('profilepictures').style.display = 'none';
