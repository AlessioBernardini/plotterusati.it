...
<div class="flex flex-wrap justify-start">
    <div class="relative inline-flex align-middle pull-right">
        <a
            ...
            class="btn btn-warning inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal  text-yellow-100 bg-yellow-500 hover:bg-yellow-400"
        ...
        <a
            ...
            class="btn btn-danger inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal  text-red-100 bg-red-500 hover:bg-red-400"
            data-toggle="confirmation"
