                        ...
                        <?if( isset($value['thumb']) AND isset($value['image']) ):?>
                            <div class="col-xs-6 col-sm-6 col-md-3">
                                <a href="<?= $value['image']?>" class="thumbnail gallery-item" data-gallery>
                                    <?=HTML::picture($value['image'], array('w' => 200, 'h' => 200), array('1200px' => array('w' => '125', 'h' => '125'), '992px' => array('w' => '87', 'h' => '87'), '320px' => array('w' => '200', 'h' => '200')), array('alt' => HTML::chars($ad->title), 'class' => 'center-block img-responsive img-rounded'))?>
                                </a>
                            </div>
                        <?endif?>
                    <?endforeach?>
