                            ...
                            <div class="thumbnail latest_ads">
                                <a href="<?=Route::url('ad', array('category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>">
                                    <?if($ad->get_first_image()!== NULL):?>
                                        <?=HTML::picture($ad->get_first_image(), ['w' => 177, 'h' => 177], ['1200px' => ['w' => '177', 'h' => '177'],'992px' => ['w' => '140', 'h' => '140'], '768px' => ['w' => '199', 'h' => '199']], array('class' => 'center-block', 'alt' => HTML::chars($ad->title)))?>
                                    <?elseif( ($icon_src = $ad->category->get_icon()) !== FALSE):?>
                                        <?=HTML::picture($icon_src, ['w' => 177, 'h' => 177], ['1200px' => ['w' => '177', 'h' => '177'],'992px' => ['w' => '140', 'h' => '140'], '768px' => ['w' => '199', 'h' => '199']], array('class' => 'center-block', 'alt' => HTML::chars($ad->title)))?>
                                    <?else:?>
                                        <img data-src="holder.js/177x177?<?=str_replace('+', ' ', http_build_query(array('text' => $ad->category->translate_name(), 'size' => 14, 'auto' => 'yes')))?>" alt="<?=HTML::chars($ad->title)?>">
                                    <?endif?>
                                </a>
                                <div class="caption">
...
?>
    ...
    <div id="products" class="list-group">
        <?$i=1;
        foreach($ads as $ad ):?>
            <div class="item <?=(core::cookie('list/grid')==1)?'list-group-item':'grid-group-item'?> col-lg-4 col-md-4 col-sm-4 col-xs-12 <?=($ad->featured >= Date::unix2mysql(time()) AND core::cookie('list/grid')==1)?'featured-item':''?>">
                <div class="<?=($ad->featured >= Date::unix2mysql(time()))?'featured-item':''?> thumbnail">
                    ...
                    <?if($ad->featured >= Date::unix2mysql(time())):?>
                        <div class="pull-right">
                            <span class="label label-danger"><?=_e('Featured')?></span>&nbsp;
                        </div>
                    <?endif?>
                    <?if (Core::config('advertisement.reviews')==1):?>
                    ...
                    <div class="picture">
                        <a class="pull-left" title="<?=HTML::chars($ad->title)?>" alt="<?=HTML::chars($ad->title)?>" href="<?=Route::url('ad', array('controller'=>'ad','category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>">
                            <figure>
                                <?if($ad->get_first_image() !== NULL):?>
                                    <img src="<?=Core::imagefly($ad->get_first_image(),110,110)?>" alt="<?=HTML::chars($ad->title)?>" />
                                <?elseif(( $icon_src = $ad->category->get_icon() )!==FALSE ):?>
                                    <img src="<?=Core::imagefly($icon_src,110,110)?>" alt="<?=HTML::chars($ad->title)?>" />
                                <?else:?>
                                    <img data-src="holder.js/110x110?<?=str_replace('+', ' ', http_build_query(array('text' => $ad->category->translate_name(), 'size' => 14, 'auto' => 'yes')))?>" alt="<?=HTML::chars($ad->title)?>">
                                <?endif?>
                            </figure>
                        </a>
                    </div>
            ...
            <?if($i===$position):?>
                <div class="item <?=(core::cookie('list/grid')==1)?'list-group-item':'grid-group-item'?> col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="thumbnail">
