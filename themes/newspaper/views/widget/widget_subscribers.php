...
<div class="panel-body">
    ...
    <?endif?>
        <div class="">
            <?= FORM::button(NULL, _e('Subscribe'), array('type'=>'submit', 'class'=>'btn btn-success', 'action'=>Route::url('default', array('controller'=>'subscribe', 'action'=>'index','id'=>$widget->user_id))))?>
