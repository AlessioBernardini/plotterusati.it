...
<h1 class="listings-title"><span><?= _e('Users')?></span></h1>
                ...
                <?foreach(Model_UserField::get_all() as $name=>$field):?>
                    <?if(isset($field['searchable']) AND $field['searchable']):?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <?= FORM::label('cf_'.$name, $field['label'], array('class'=>'', 'for'=>'cf_'.$name))?>
                                <div>
        ...
        <div class="col-sm-4" style="min-height:350px">
            <div class="thumbnail">
                <a title="<?=HTML::chars($user->name)?>" href="<?=Route::url('profile',  array('seoname'=>$user->seoname))?>">
                    <?=HTML::picture($user->get_profile_image('image'), array('w' => 250, 'h' => 250), array('1200px' => array('w' => '179', 'h' => '179'), '992px' => array('w' => '179', 'h' => '179'), '768px' => array('w' => '250', 'h' => '250'), '480px' => array('w' => '250', 'h' => '250'), '320px' => array('w' => '250', 'h' => '250')), array('class' => 'img-responsive center-block', 'alt' => _e('Profile Picture')))?>
                </a>
                <div class="caption">
                    <h3>
                        <a title="<?=HTML::chars($user->name)?>" href="<?=Route::url('profile',  array('seoname'=>$user->seoname))?>">
