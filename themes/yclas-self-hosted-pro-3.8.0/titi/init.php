...
/**
  * Theme Name: Titi
  * Description: The Titi theme is the advanced version of Ocean Free. This theme supports all the premium features that are offered like custom fields. Titi also offers infinite scroll and supports right-to-left. Furthermore the design is completely responsive, what makes it ideal for mobile devices.
 ...
 */
Widgets::$theme_placeholders  = array('sidebar', 'listing', 'single', 'footer');
...
if (Core::config('appearance.allow_query_theme')=='1')
{
    ...
    elseif (Cookie::get('skin_titi')!=='')
    {
        Theme::$skin = Cookie::get('skin_titi');
    }
    ...
    Cookie::set('skin_titi', Theme::$skin, 10*60);
}

$theme_css = array( '//cdn.jsdelivr.net/npm/bootstrap@3.4.0/dist/css/bootstrap.css' => 'screen',
                    ...
                    '//cdn.jsdelivr.net/jquery.swipebox/1.2.1/swipebox.css' => 'screen',
                    'css/slider.css' => 'screen',
                    'css/zocial.css' => 'screen',
                    'css/styles.css?v='.Core::VERSION => 'screen',
                    'css/styles.custom.css?v='.Core::VERSION => 'screen',
                    );
...
Theme::$scripts['footer'] = array(  '//cdn.jsdelivr.net/combine/npm/jquery@1.12.3,npm/bootstrap@3.4.0/dist/js/bootstrap.min.js,npm/select2@4.0.2,npm/jquery-validation@1.19.0,npm/holderjs@2.8.1',
                                    '//cdn.jsdelivr.net/g/bootstrap.datepicker@0.1',
                                    ...
                                    '//cdn.jsdelivr.net/masonry/4.0.0/masonry.pkgd.min.js',
                                    '//cdnjs.cloudflare.com/ajax/libs/jquery.simpleWeather/3.1.0/jquery.simpleWeather.min.js',
                                    '//cdn.jsdelivr.net/jquery.swipebox/1.2.1/jquery.swipebox.min.js',
                                    '//cdn.jsdelivr.net/momentjs/2.14.1/moment.min.js',
                                    '//cdn.jsdelivr.net/momentjs.timezone/0.5.4/moment-timezone-with-data.min.js',
                                    ...
                                    'js/theme.custom.init.js?v='.Core::VERSION,
...
*/
/*if (Model_Domain::current()->id_domain != '1' AND Auth::instance()->logged_in() AND Auth::instance()->get_user()->is_admin())
{
