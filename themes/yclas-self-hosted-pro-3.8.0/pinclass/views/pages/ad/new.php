	        ...
	        <?= FORM::open(Route::url('post_new',array('controller'=>'new','action'=>'index')), array('class'=>'form-horizontal post_new', 'id'=>'publish-new', 'enctype'=>'multipart/form-data'))?>
	            <fieldset class="tab-content">
	                ...
	                <div class="tab-pane" role="tabpanel" id="step3">
						...
						<div class="form-group">
							<?= FORM::label('price', _e('Price'), array('class'=>'control-label col-xs-12 col-sm-3', 'for'=>'price'))?>
						...
						<div class="form-group">
							<?= FORM::label('stock', _e('In Stock'), array('class'=>'control-label col-xs-12 col-sm-3', 'for'=>'stock'))?>
							<div class="col-xs-12 col-sm-9">
								<div class="input-prepend">
						...
						<div id="custom-fields" data-customfield-values='<?=json_encode(Request::current()->post())?>'>
							<div id="custom-field-template" class="hidden form-group">
								<div class="col-xs-12 col-sm-3 pull-left control-label">
									<div data-label></div>
								</div>
								<div class="col-xs-12 col-sm-9 pull-right <?=Theme::get('dark_listing')?'dark_listing_new':''?>">
									<div data-input></div>
								</div>
							</div>
						</div>
...
<div class="modal modal-statc fade" id="processing-modal" data-backdrop="static" data-keyboard="false">
	<div class="modal-body">
		<div class="modal-dialog">
			<div class="modal-content <?=(Theme::get('dark_listing'))?'dark-container':''?>">
