...
<div class="page-header">
    <article id="user_profile_info" class="well <?=(Theme::get('dark_listing'))?'dark_listing':''?>">
        ...
        <div id="contact-modal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content <?=(Theme::get('dark_listing'))?'dark_listing':''?>">
...
<?if($profile_ads!==NULL):?>
    <?foreach($profile_ads as $ad):?>
        <?if($ad->featured >= Date::unix2mysql(time())):?>
            <article id="user_profile_ads" class="well <?=(Theme::get('dark_listing'))?'dark_listing':'featured'?>">
                <span class="label label-danger pull-right"><?=_e('Featured')?></span>
        <?else:?>
            <article id="user_profile_ads" class="well <?=(Theme::get('dark_listing'))?'dark_listing':''?>">
        <?endif?>
