<div class="page-header">
    ...
    <h1 class="forum-title pull-left"><?=_e('Search for topics')?> <?=HTML::chars(core::get('search'))?></h1>
        ...
        <tbody>
            <?foreach($topics as $topic):?>
                ...
                <tr>
                    ...
                    <td><a title="<?=HTML::chars($topic->forum->name)?>" href="<?=Route::url('forum-list', array('forum'=>$topic->forum->seoname))?>"><?=$topic->forum->name?></a></td>
                    <td class="text-muted"><small><?=Date::format($topic->created, core::config('general.date_format'))?></small></td>
                    <?if (Auth::instance()->logged_in()):?>
