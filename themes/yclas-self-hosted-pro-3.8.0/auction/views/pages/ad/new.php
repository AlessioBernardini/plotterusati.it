...
<div class="row">
    <div class="<?=core::count(Widgets::render('publish_new')) > 0 ? 'col-lg-9 col-md-9 col-sm-12 col-xs-12' : 'col-xs-12'?> <?=(core::count(Widgets::render('publish_new')) > 0 AND Theme::get('sidebar_position')=='left') ? 'col-lg-push-3 col-md-push-3' : NULL?>">
        ...
        <div id="publish_new_form" class="well">
            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-8 col-xs-12">
                                        ...
                                        <div class="input-prepend">
                                            <?= FORM::input('price', Request::current()->post('price'), array('placeholder' => html_entity_decode(html_entity_decode(i18n::money_format(1))), 'class' => 'form-control', 'id' => 'price', 'type'=>'text', 'data-error' => __('Please enter only numbers.'), 'data-decimal_point' => i18n::get_decimal_point(), 'required'))?>
                                        </div>
                                    </div>
                                </div>
                            <?endif?>
                            ...
                            <?if(core::config('payment.stock')):?>
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-8 col-xs-12">
                                        ...
                                        <div class="input-prepend">
                                            <?= FORM::input('stock', Core::post('stock', 1), array('placeholder' => '10', 'placeholder' => '10', 'class' => 'form-control', 'id' => 'stock', 'type'=>'text'))?>
                                        </div>
                                    </div>
                                </div>
                            <?endif?>
