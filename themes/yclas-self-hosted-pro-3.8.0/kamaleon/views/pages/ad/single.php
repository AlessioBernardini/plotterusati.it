<?php defined('SYSPATH') or die('No direct script access.');?>
    ...
    <?if((core::config('payment.pay_to_go_on_top') > 0
        ...
        <div id="recomentadion" class="well recomentadion clearfix">
            <?if(core::config('payment.pay_to_go_on_top') > 0 && core::config('payment.to_top') != FALSE):?>
                ...
                <p><a class="btn btn-xs btn-primary" type="button" href="<?=Route::url('default', array('action'=>'to_top','controller'=>'ad','id'=>$ad->id_ad))?>"><?=_e('Go Top!')?></a></p>
            <?endif?>
            <?if(core::config('payment.to_featured') != FALSE AND $ad->featured < Date::unix2mysql()):?>
                ...
                <p><a class="btn btn-xs btn-primary" type="button" href="<?=Route::url('default', array('action'=>'to_featured','controller'=>'ad','id'=>$ad->id_ad))?>"><?=_e('Go Featured!')?></a></p>
            <?endif?>
        </div>
    <?endif?>
    <?endif?>
                        ...
                        <?if( isset($value['thumb']) AND isset($value['image']) ):?>
                            <div class="col-md-3">
                                <a href="<?= $value['image']?>" class="thumbnail gallery-item" data-gallery>
                                    <?=HTML::picture($value['image'], array('w' => 200, 'h' => 200), array('1200px' => array('w' => '117', 'h' => '117'), '992px' => array('w' => '89', 'h' => '89'), '768px' => array('w' => '200', 'h' => '200'), '480px' => array('w' => '200', 'h' => '200'), '320px' => array('w' => '200', 'h' => '200')), array('alt' => HTML::chars($ad->title), 'class' => 'img-responsive img-rounded center-block'))?>
                                </a>
                            </div>
                        <?endif?>
                    <?endforeach?>
    ...
    <?endif?>
        ...
        <div class=" ">
            ...
            <span class="label label-danger price-curry"><?= _e('Price');?> : <?=_e('Free');?></span>
            <?endif?>
            <?if ($ad->id_location != 1):?>
