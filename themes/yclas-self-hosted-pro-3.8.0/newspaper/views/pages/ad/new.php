...
<h1 class="listings-title"><span><?=_e('Publish new advertisement')?></span></h1>
<div class="row">
    <div class="<?=core::count(Widgets::render('publish_new')) > 0 ? 'col-lg-8 col-md-8 col-sm-12 col-xs-12' : 'col-xs-12'?> <?=(core::count(Widgets::render('publish_new')) > 0 AND Theme::get('sidebar_position')=='left') ? 'col-lg-push-4 col-md-push-4' : NULL?>">
        <?=FORM::open(Route::url('post_new',array('controller'=>'new','action'=>'index')), array('class'=>'form-horizontal post_new', 'id'=>'publish-new', 'enctype'=>'multipart/form-data'))?>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <!-- category select -->
                        <div class="col-sm-12">
                            <?= FORM::label('category', _e('Category'), array('class'=>'control-label', 'for'=>'category'))?>
                            ...
                            >
                                <div id="select-category-template" class="col-sm-6 hidden">
                                    <select class="disable-select2 select-category" placeholder="<?=__('Pick a category...')?>"></select>
                                </div>
                                <div id="paid-category" class="col-sm-12 hidden">
                        ...
                        <?if($form_show['location'] != FALSE):?>
                            <div class="col-sm-12">
                                <?= FORM::label('locations', _e('Location'), array('class'=>'control-label', 'for'=>'location'))?>
                                <div id="location-chained" class="row <?=($id_location === NULL) ? NULL : 'hidden'?>" data-apiurl="<?=Route::url('api', array('version'=>'v1', 'format'=>'json', 'controller'=>'locations'))?>">
                                    <div id="select-location-template" class="col-sm-6 hidden">
            ...
            <div id="custom-fields-wrapper" class="panel panel-default hidden">
                <div class="panel-heading">
                    <h3 class="panel-title"><?=_e('Extra Info')?></h3>
                </div>
                <div class="panel-body">
    ...
    <?if(core::count(Widgets::render('publish_new')) > 0) :?>
        <div class="col-xs-12 col-md-4 <?=(Theme::get('sidebar_position')=='left') ? 'col-md-pull-8' : NULL?>">
            <div id="sidebar">
                <div class="row">
