...
/**
  * Theme Name: Basecamp premium
  * Description: The Basecamp Premium theme is the advanced version of Basecamp Free. This theme supports all the premium features that you would expect from a premium theme. Furthermore the design is completely responsive, what makes it ideal for mobile devices.
...
if (Core::config('appearance.allow_query_theme')=='1')
{
    ...
    elseif (Cookie::get('skin_basecamp')!=='')
    {
        Theme::$skin = Cookie::get('skin_basecamp');
    }
    ...
    {
        Cookie::set('skin_basecamp', Theme::$skin, 10*60);
    }
    else{
        Cookie::set('skin_basecamp', Theme::$skin, Core::config('auth.lifetime'));
    }
}
