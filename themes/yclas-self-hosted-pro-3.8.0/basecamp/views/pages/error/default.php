				...
				<?if (Auth::instance()->get_user()):?>
					<?if (Auth::instance()->get_user()->is_admin()):?>
						<br><hr><br>
							...
							<code><?=$message?></code>
							<p>It's been loged in <a href="<?=Route::url('oc-panel',array('controller'=>'tools','action'=>'logs'))?>">Panel->Extra->Tools->Logs</a> for more information regarding this error.</p>
						<br><hr><br>
					<?endif?>
				<?endif?>
