        ...
        switch (customfield.type) {
            ...
            case 'url':
                $template.find('div[data-input]').replaceWith($('<input/>').attr({  'type'        : 'text',
                                                                                    ...
                                                                                    'data-type'   : customfield.translated_type,
                                                                                    'data-toggle' : 'tooltip',
            ...
            case 'select':
                ...
                $('#custom-fields select[name="' + idx + '"]').append($('<option/>').val(''));
                ...
                $('#custom-fields select[name="' + idx + '"]').after($('<span class="help-block">' + (customfield.translated_tooltip!='null'?customfield.translated_tooltip:'') + '</span>'));
...
// Step by step process publish new
$(function(){
    //Initialize tooltips
    ...
    $(".next-step").click(function (e) {
        ...
        var $inputFields = $($active.find('a').attr('href') + ' :input');
        var isInvalid = false;
...
$(function(){
    $(".next-step").click(function() {
        $('html, body').animate({
            scrollTop: $(".wizard-inner").offset().top
        }, 500);
    });
