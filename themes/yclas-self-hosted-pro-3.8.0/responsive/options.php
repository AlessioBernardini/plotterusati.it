...
return array(   'premium' => array( 'type'      => 'numeric',
                 ...
                 'theme' => array(   'type'      => 'text',
                                                ...
                                                'required'  => TRUE,
                                                'category'  => __('Color')),
                'background_color' => array(    'type'      => 'text',
                                            'display'   => 'color',
                                            'label'     => __('Select a background color. Leave empty for default.'),
                                            'default'   => '',
                                            'category'  => __('Color')),
                ...
                'hide_categories_mobile' => array(       'type'      => 'text',
                                            'display'   => 'select',
                                            'label'     => __('Hide homepage categories section when viewed on mobile devices'),
                                            'options'   => array(   '1' => __('Yes'),
                                                                    '0'  => __('No'),
                                                                ),
                                            'default'   => '0',
