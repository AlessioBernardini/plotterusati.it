...
<section id="main">
    <div class="container no-gutter">
        <div class="row">
            <div class="<?=core::count(Widgets::render('publish_new')) > 0 ? 'col-xs-12 col-sm-8 col-md-9' : 'col-xs-12'?> <?=(core::count(Widgets::render('publish_new')) > 0 AND Theme::get('sidebar_position')=='left') ? 'col-sm-push-4 col-md-push-3' : NULL?>">
