...
<h3 class="h3"><?=$widget->subscribe_title?></h3>
...
<?endif?>
	<div class="">
		<?= FORM::button(NULL, _e('Subscribe'), array('type'=>'submit', 'class'=>'btn color-primary', 'action'=>Route::url('default', array('controller'=>'subscribe', 'action'=>'index','id'=>$widget->user_id))))?>
