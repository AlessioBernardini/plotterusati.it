...
<?=Form::errors()?>
<form class="form-horizontal cwell auth"  method="post" action="<?=Route::url('oc-panel',array('directory'=>'user','controller'=>'auth','action'=>'register'))?>">

    <div class="form-group">
        <label class="col-lg-3 control-label"><?=_e('Name')?></label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><?=_e('Email')?></label>
        <div class="col-lg-5">
            <input
                class="form-control"
                type="text"
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><?=_e('New password')?></label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-3 control-label"><?=_e('Repeat password')?></label>
        <div class="col-lg-5">
    ...
    <?foreach(Model_UserField::get_all() as $name=>$field):?>
        <?if($field['show_register'] AND $name!='verifiedbadge' AND $name!='whatsapp'):?>
            <div class="form-group">
                ...
                <?= FORM::label('cf_'.$name, $field['label'], array('class'=>'col-lg-3 control-label', 'for'=>'cf_'.$name))?>
                <div class="col-lg-5">
        ...
        <?elseif($name=='whatsapp'):?>
            <div class="form-group" id="cf_new">
                <label class="col-lg-3 control-label" for="cf_whatsapp"><?=_e('Whatsapp Number')?></label>
                <div class="col-lg-5">
    ...
    <div class="form-group">
        <?if (Core::config('advertisement.captcha')):?>
            ...
            <?else:?>
                <label class="col-lg-3 control-label"><?=_e('Captcha')?>*:</label>
                <div class="col-lg-5">
