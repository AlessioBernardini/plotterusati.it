...
<?if(Auth::instance()->logged_in()):?>
    ...
    <?elseif ($ads = Auth::instance()->get_user()->contacts() AND core::count($ads) > 0) :?>
        <li class="log">
            <a class="btn btn-mini btn-success dropdown-toggle" data-toggle="dropdown"
            ...
            <ul id="contact-notification-dd" class="dropdown-menu dropdown-menu-right" style="padding-left:15px; padding-right:15px;">
