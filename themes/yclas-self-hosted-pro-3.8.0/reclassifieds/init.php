...
/**
  * Theme Name: reClassifieds
  * Description: The reClassifieds 3 theme is the most popular theme among our users. The design is minimalistic, clean and modern. The organized look makes it easy to navigate through a classifieds website made with reClassifieds 3. There are 3 different color schemes available and all premium features are supported.
  * Tags: HTML5,, Premium, Admin Themes, prettyPhoto, Slider.
  * Version: 3.8.0
  * Author: Roberto Stringa, Thom Wensink
  * License: Commercial
  * Parent Theme: default
  * Skins: default,blue,orange
  */
...
if (Core::config('appearance.allow_query_theme')=='1')
{
    ...
    elseif (Cookie::get('skin_reclassifieds')!=='')
    {
        Theme::$skin = Cookie::get('skin_reclassifieds');
    }
    ...
    {
        Cookie::set('skin_reclassifieds', Theme::$skin, 10*60);
    }
    else{
        Cookie::set('skin_reclassifieds', Theme::$skin, Core::config('auth.lifetime'));
    }
}
