                    ...
                    <div class="active item">
                        <ul class="row thumbnails list-unstyled">
                            <?$i=0; foreach ($ads as $ad):?>
                                <?if ($i%4==0 AND $i!=0):?></ul></div><div class="item"><ul class="row thumbnails list-unstyled"><?endif?>
                                    ...
                                    <div class="thumbnail gradient-gray max-h">
                                        <a href="<?=Route::url('ad', array('category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>" class="min-h">
                                            <?if($ad->get_first_image()!== NULL):?>
                                                <?=HTML::picture($ad->get_first_image('image'), ['w' => 250, 'h' => 250], ['1200px' => ['w' => '250', 'h' => '250'], '992px' => ['w' => '193', 'h' => '193'], '768px' => ['w' => '138', 'h' => '138'], '480px' => ['w' => '250', 'h' => '250'], '320px' => ['w' => '250', 'h' => '250']], ['class' => 'center-block img-responsive', 'alt' => HTML::chars($ad->title)])?>
                                            <?elseif( ($icon_src = $ad->category->get_icon()) !== FALSE):?>
                                                <?=HTML::picture($icon_src, ['w' => 250, 'h' => 250], ['1200px' => ['w' => '250', 'h' => '250'], '992px' => ['w' => '193', 'h' => '193'], '768px' => ['w' => '138', 'h' => '138'], '480px' => ['w' => '250', 'h' => '250'], '320px' => ['w' => '250', 'h' => '250']], ['class' => 'center-block img-responsive', 'alt' => HTML::chars($ad->title)])?>
                                            <?else:?>
                                                <img data-src="holder.js/250x250?<?=str_replace('+', ' ', http_build_query(array('text' => $ad->category->translate_name(), 'size' => 12, 'auto' => 'yes')))?>" class="center-block img-responsive" alt="<?=HTML::chars($ad->title)?>">
                                            <?endif?>
                                        </a>
...
<?if (Theme::get('hide_categories_mobile')):?>
<div class="well categories clearfix hidden-sm hidden-xs">
<?else:?>
                ...
                <div class="col-md-4">
                    <ul class="list-unstyled">
                        <li class="cathead">
                            ...
                            <?endif?>
                            <a title="<?=HTML::chars((strip_tags($c['description'])!=='')?strip_tags($c['description']):$c['translate_name'])?>" href="<?=Route::url('list', array('category'=>$c['seoname'], 'location'=>$user_location ? $user_location->seoname : NULL))?>"><?=($c['translate_name']);?></a>
                        </li>
