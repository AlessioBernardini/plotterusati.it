                            ...
                            <div class="thumbnail latest_ads">
                                <a href="<?=Route::url('ad', array('category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>" class="min-h">
                                    <?if($ad->get_first_image()!== NULL):?>
                                        <?=HTML::picture($ad->get_first_image('image'), ['w' => 200, 'h' => 200], ['1200px' => ['w' => '200', 'h' => '200'], '992px' => ['w' => '150', 'h' => '150'], '768px' => ['w' => '205', 'h' => '205'], '480px' => ['w' => '345', 'h' => '345'], '320px' => ['w' => '200', 'h' => '200']], ['alt' => HTML::chars($ad->title)])?>
                                    <?elseif( ($icon_src = $ad->category->get_icon()) !== FALSE):?>
                                        <?=HTML::picture($icon_src, ['w' => 200, 'h' => 200], ['1200px' => ['w' => '200', 'h' => '200'], '992px' => ['w' => '150', 'h' => '150'], '768px' => ['w' => '205', 'h' => '205'], '480px' => ['w' => '345', 'h' => '345'], '320px' => ['w' => '200', 'h' => '200']], ['alt' => HTML::chars($ad->title)])?>
                                    <?else:?>
...
?>
    ...
    <div id="products" class="list-group">
        ...
        foreach($ads as $ad ):?>
                    ...
                    <div class="picture">
                        <a class="pull-left" title="<?=HTML::chars($ad->title)?>" alt="<?=HTML::chars($ad->title)?>" href="<?=Route::url('ad', array('controller'=>'ad','category'=>$ad->category->seoname,'seotitle'=>$ad->seotitle))?>">
                            <figure>
                                ...
                                <?elseif(( $icon_src = $ad->category->get_icon() )!==FALSE ):?>
                                    <img src="<?=Core::imagefly($icon_src,150,150)?>" alt="<?=HTML::chars($ad->title)?>">
                                <?else:?>
                                    <img data-src="holder.js/150x150?<?=str_replace('+', ' ', http_build_query(array('text' => $ad->category->translate_name(), 'size' => 12, 'auto' => 'yes')))?>" alt="<?=HTML::chars($ad->title)?>">
                                <?endif?>
                            </figure>
                        </a>
                    </div>
            ...
            <?endif?>
            <?if($i%3==0):?></div><div class="clearfix">&nbsp;</div><?endif?>
            <?$i++?>
        <?endforeach?>
    </div>
    <div class="clearfix"></div>
