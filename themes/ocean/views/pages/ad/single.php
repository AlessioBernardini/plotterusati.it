                        ...
                        <?if( isset($value['thumb']) AND isset($value['image']) ):?>
                            <div class="col-xs-6 col-sm-3 col-md-3">
                                <a href="<?=$value['image']?>" class="thumbnail gallery-item" data-gallery>
                                    <?=HTML::picture($value['image'], array('w' => 280, 'h' => 280), array('1200px' => array('w' => '200', 'h' => '200'), '992px' => array('w' => '200', 'h' => '200'), '768px' => array('w' => '205', 'h' => '205'), '480px' => array('w' => '344', 'h' => '344'), '320px' => array('w' => '200', 'h' => '200')), array('alt' => HTML::chars($ad->title), 'class' => 'img-responsive img-rounded'))?>
                                </a>
                            </div>
                        <?endif?>
                    <?endforeach?>
